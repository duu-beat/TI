    ...
    <x-slot name="header">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 uppercase tracking-widest mt-0.5">Padronizar procedimentos técnicos por categoria</p>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative overflow-hidden rounded-3xl bg-slate-900 border border-white/10 shadow-2xl">
                ...
                <form action="{{ route('admin.checklists.store') }}" method="POST" x-data="{ items: [''] }" class="relative z-10 p-8 sm:p-10 space-y-8">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="title" required placeholder="Ex: Checklist de Instalação de Impressora"
                        ...
                        <div>
                            ...
                            <select name="category" required 
                                ...
                                <option value="" class="bg-slate-900">Selecione uma categoria</option>
                                <option value="Hardware" class="bg-slate-900">Hardware</option>
                                <option value="Software" class="bg-slate-900">Software</option>
                                <option value="Rede" class="bg-slate-900">Rede</option>
                                <option value="Acessos" class="bg-slate-900">Acessos</option>
                        ...
                        <div class="space-y-3">
                            <template x-for="(item, index) in items" :key="index">
                                <div class="flex items-center gap-3 group animate-fade-in-up">
                                    ...
                                    <input type="text" name="items[]" required placeholder="Descreva o passo técnico..."
                                           class="flex-1 bg-slate-950/50 border-white/5 rounded-xl py-2.5 px-4 text-slate-200 focus:border-indigo-500/50 focus:bg-slate-900 focus:ring-2 focus:ring-indigo-500/10 outline-none transition placeholder-slate-700 text-sm">
