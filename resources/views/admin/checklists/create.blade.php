    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('admin.checklists.store') }}" method="POST" x-data="{ items: [''] }">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <x-input id="title" name="title" type="text" class="mt-1 block w-full" placeholder="Ex: Checklist de Instalação de Impressora" required />
                        ...
                        <div class="space-y-3">
                            <template x-for="(item, index) in items" :key="index">
                                <div class="flex items-center gap-2">
                                    ...
                                    <x-input name="items[]" type="text" class="block w-full" placeholder="Descreva o passo técnico..." required />
