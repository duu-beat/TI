    ...
    <div x-data="{ loaded: false }" x-init="setTimeout(() => loaded = true, 500)" class="py-8">
        ...
        <div x-show="loaded" style="display: none;" 
            ...
            @if(isset($unassignedCount) && $unassignedCount > 0)
                <section class="rounded-2xl border border-amber-500/30 bg-amber-500/10 p-5" aria-labelledby="unassigned-tickets-title">
                    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div class="flex items-center gap-4">
                            <div class="rounded-xl bg-amber-500/20 p-3 text-amber-400">
            ...
            @if(isset($agentStats) && count($agentStats) > 0)
                <section class="rounded-2xl border border-white/10 bg-slate-900/50 p-6" aria-labelledby="agent-ranking-title">
