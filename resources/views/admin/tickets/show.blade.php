                ...
                <div class="fixed bottom-0 left-0 right-0 z-40 pb-6 px-4 pointer-events-none">
                    <div class="max-w-4xl mx-auto pointer-events-auto">
                        ...
                        <form method="POST" action="{{ route('admin.tickets.reply', $ticket) }}" enctype="multipart/form-data"
                            ...
                            <x-validation-errors class="mx-3 mt-3" />
                            ...
                            <div x-show="errors.length" x-cloak class="mx-3 mt-3 rounded-xl border border-red-500/20 bg-red-500/10 p-2 text-xs text-red-200" role="alert">
                                <template x-for="error in errors" :key="error"><p x-text="error"></p></template>
                            </div>

                            <div x-show="files.length" x-cloak class="grid grid-cols-2 gap-2 border-b border-white/5 p-3 sm:grid-cols-5">
                            ...
                            <div class="flex items-end gap-2 p-3">
                                ...
                                <div class="relative shrink-0">
                                    ...
                                    <label for="admin-file-upload" class="flex h-10 w-10 items-center justify-center rounded-xl hover:bg-indigo-500/10 hover:text-indigo-300 text-slate-400 cursor-pointer transition active:scale-95 group" title="Anexar arquivos com prévia">
