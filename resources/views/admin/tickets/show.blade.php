    ...
    <x-slot name="header">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex min-w-0 items-center gap-3">
                ...
                <div class="min-w-0">
                    <div class="flex flex-wrap items-center gap-2"><span class="rounded-md border border-indigo-400/20 bg-indigo-500/10 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-indigo-300">{{ $ticket->category->name ?? $ticket->category ?? 'Suporte' }}</span><span class="text-[11px] text-slate-500">Criado {{ $ticket->created_at->diffForHumans() }}</span></div>
