            ...
            <div class="lg:col-span-3">
                ...
                <div x-show="loaded" style="display: none;" 
                    ...
                    <div class="mb-8 border-b border-white/10 pb-8 print:border-black/10">
                        <h1 class="text-4xl font-bold text-white mb-2 print:text-black">{{ __('messages.public.terms_title') }}</h1>
                        <p class="text-slate-400 print:text-gray-600">{{ __('messages.public.terms_description') }}</p>
                    </div>
